...
class CustomScaleTextField1 extends StatefulWidget {
  ...
  @override
  _CustomScaleTextField1State createState() => _CustomScaleTextField1State();
}

class _CustomScaleTextField1State extends State<CustomScaleTextField1> {
