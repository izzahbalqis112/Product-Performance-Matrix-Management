...
class CalendarWidgetState extends State<CalendarWidget> {
  ...
  bool isStartDateRadius(DateTime date) {
    return startDate != null && startDate!.isAtSameMomentAs(date);
  }

  bool isEndDateRadius(DateTime date) {
    return endDate != null && endDate!.isAtSameMomentAs(date);
  }
  ...
  Future<void> _showEventsForDate(DateTime date) async {
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          title: Text('Events for ${DateFormat('MMMM d, yyyy').format(date)}'),
          content: Column(
            mainAxisSize: MainAxisSize.min,
            children: eventsForDate.isNotEmpty
                ? eventsForDate
                    .map((event) => ListTile(
