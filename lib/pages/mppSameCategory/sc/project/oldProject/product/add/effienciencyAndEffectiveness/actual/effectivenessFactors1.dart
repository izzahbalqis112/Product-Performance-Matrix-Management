...
class EffectivenessFactors1Page extends StatefulWidget {
  ...
  EffectivenessFactors1Page({required this.projectId, required this.productId});

  @override
  _EffectivenessFactors1PageState createState() => _EffectivenessFactors1PageState();
}
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            CustomTextFieldNew(
                              ...
                              validator: (value) {
                                // Validation logic for plannedVariableCostPerUnit
                                if (value == null || value.isEmpty) {
