...
import 'effectivenessFactors.dart';

class EfficiencyFactorsPage extends StatefulWidget {
  final String projectId;
  final String productId;

  EfficiencyFactorsPage({required this.projectId, required this.productId});

  @override
  _EfficiencyFactorsPageState createState() => _EfficiencyFactorsPageState();
}

class _EfficiencyFactorsPageState extends State<EfficiencyFactorsPage> with SingleTickerProviderStateMixin{
  ...
  void _saveEfficiency() async {
    try {
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(builder: (context) => EffectivenessFactorsPage(projectId: widget.projectId, productId: widget.productId)),
      );
    } catch (e) {
                    ...
                    children: [
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            CustomTextFieldNew(
                              ...
                              hintText: 'Enter maximum planned unit sales',
                              prefixIcon: Icons.monetization_on,
                              isValid: true,
                              suffixText: 'unit',
                              onChanged: (value) {
                            ...
                            Text(
                              'Maximum Planned Revenue :',
                              style: AppFonts.text16Bold(AppColor.deepGreen1),
                            ),
                            SizedBox(height: 8),
                            CustomTextFieldNew(
                              controller: _maxPlannedRevenueController,
                              hintText: 'Enter maximum planned revenue',
                              prefixIcon: Icons.monetization_on,
                              isValid: true,
                              suffixText: 'RM',
                              onChanged: (value) {
                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            SizedBox(height: 20),
                            Text(
                              'Planned Customer Satisfaction Rate :',
                              style: AppFonts.text16Bold(AppColor.deepGreen1),
                            ),
                            SizedBox(height: 8),
                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              'Planned Cost Efficiency Metrics :',
                              style: AppFonts.text16Bold(AppColor.deepGreen1),
                            ),
                            SizedBox(height: 8),
                            CustomTextFieldNew(
                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            SizedBox(height: 20),
                            Text(
                              'Planned Process Cycle Efficiency (PCE) :',
                              style: AppFonts.text16Bold(AppColor.deepGreen1),
                            ),
                            SizedBox(height: 8),
                            CustomTextFieldNew(
                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            Text(
                              'Planned Prototype Iteration Time :',
                              style: AppFonts.text16Bold(AppColor.deepGreen1),
                            ),
                            SizedBox(height: 8),
                            CustomTextFieldNew(
                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            Text(
                              'Planned Waste Reduction Target :',
                              style: AppFonts.text16Bold(AppColor.deepGreen1),
                            ),
                            SizedBox(height: 8),
                            CustomTextFieldNew(
                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            SizedBox(height: 20),
                            Text(
                              'Planned Manufacturing Efficiency :',
                              style: AppFonts.text16Bold(AppColor.deepGreen1),
                            ),
                            SizedBox(height: 8),
                            CustomTextFieldNew(
                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            Text(
                              'Planned Milestones Achievement:',
                              style: AppFonts.text16Bold(AppColor.deepGreen1),
                            ),
                            SizedBox(height: 8),
                            CustomTextFieldNew(
                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            SizedBox(height: 20),
                            Text(
                              'Planned Compliance with Regulations:',
                              style: AppFonts.text16Bold(AppColor.deepGreen1),
                            ),
                            SizedBox(height: 8),
                            CustomTextFieldNew(
                            ...
                            SizedBox(height: 20),
                            Text(
                              'Planned Collaboration and Partnership:',
                              style: AppFonts.text16Bold(AppColor.deepGreen1),
                            ),
                            SizedBox(height: 8),
                            CustomTextFieldNew(
